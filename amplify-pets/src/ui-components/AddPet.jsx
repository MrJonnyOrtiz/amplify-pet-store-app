...
export default function AddPet(props) {
  ...
  const [
    textFieldThreeSixFiveNineTwoSevenSixOneValue,
    setTextFieldThreeSixFiveNineTwoSevenSixOneValue,
  ] = useStateMutationAction("");
  const [
    textFieldThreeSixFiveNineTwoSevenSevenFiveValue,
    setTextFieldThreeSixFiveNineTwoSevenSevenFiveValue,
  ] = useStateMutationAction("");
  const buttonTwoNineSevenSixSixNineTwoSixOnClick = useDataStoreCreateAction({
    fields: {
      ...
      type: textFieldTwoNineSevenSixSixNineTwoFourValue,
      about: textFieldThreeSixFiveNineTwoSevenSixOneValue,
      image: textFieldThreeSixFiveNineTwoSevenSevenFiveValue,
    },
    model: Pet,
    schema: schema,
  });
  const buttonThreeSixFiveNineTwoSevenEightThreeOnClick =
    useDataStoreUpdateAction({
      fields: {
        name: textFieldTwoNineSevenSixSixNineTwoTwoValue,
        age: textFieldTwoNineSevenSixSixNineTwoThreeValue,
      ...
      >
        ...
        >
          <Text
            ...
            whiteSpace="pre-wrap"
            children="Add a Pet"
            {...getOverrideProps(overrides, "Add a Pet")}
          ></Text>
          <View
            width="24px"
            height="24px"
        ...
        >
          ...
          <TextField
            ...
            labelHidden={false}
            variation="default"
            value={textFieldThreeSixFiveNineTwoSevenSixOneValue}
            onChange={(event) => {
              setTextFieldThreeSixFiveNineTwoSevenSixOneValue(
                event.target.value
              );
            }}
            {...getOverrideProps(overrides, "TextField36592761")}
          ></TextField>
          <TextField
            width="unset"
            height="unset"
            ...
            labelHidden={false}
            variation="default"
            value={textFieldThreeSixFiveNineTwoSevenSevenFiveValue}
            onChange={(event) => {
              setTextFieldThreeSixFiveNineTwoSevenSevenFiveValue(
                event.target.value
              );
            }}
            {...getOverrideProps(overrides, "TextField36592775")}
          ></TextField>
        </Flex>
        <Divider
          width="unset"
        ...
        >
          ...
          <Button
            ...
            children="Update"
            onClick={() => {
              buttonThreeSixFiveNineTwoSevenEightThreeOnClick();
            }}
            {...getOverrideProps(overrides, "Button36592783")}
          ></Button>
        </Flex>
      </Flex>
    </Flex>
